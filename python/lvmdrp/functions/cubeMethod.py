...
def measureDARPeak_drp(cube_in, out_prefix, coadd='10', steps='50', search_box='16', bary_box='6', bary_exp='4', smooth_poly='-3', start_wave='', end_wave='', clip='0.3', fibers='', res_cube='',  figure_out='', verbose='0'):
    """
...
def fitDARPeak_drp(cube_in, out_prefix, coadd='10', steps='50', search_box='16', box_size='', smooth_poly='-3', start_wave='', end_wave='', clip='0.3', fibers='', res_cube='',  figure_out='', verbose='0'):
    """
...
def createSensFunction_drp(cube_in, out_sens,  ref_spec, airmass, exptime, cent_x='CRPIX2', cent_y='CRPIX1', radius='6', smooth_poly='5', smooth_ref='6.0' , extinct_v='0.0', aper_correct='1.0',  ref_units='1e-16', target_units='1e-16',column_wave='0', column_flux='1', delimiter='', header='1' , split='', mask_wave='', overlap='100', out_star='', verbose='0'):
    smooth_poly=int(smooth_poly)
    smooth_ref=float(smooth_ref)
    radius = float(radius)
    ...
    extinct = 10**(ancillary_func.extinctCAHA(star_spec._wave, extinct_v)*airmass*-0.4)
    ...
    if split=='':
        ...
        mask[:10]=True
        mask[-10:]=True
        sens_func_smooth = Spectrum1D(wave=sens_func._wave, data=sens_func._data, mask=mask)
